...
const DATA_DIR = 'train-data';
const TRAIN_IMAGES_FILE = path.join(DATA_DIR, 'train-images-idx3-ubyte');
const TRAIN_LABELS_FILE = path.join(DATA_DIR, 'train-labels-idx1-ubyte');
const TEST_IMAGES_FILE = path.join(DATA_DIR, 't10k-images-idx3-ubyte');
const TEST_LABELS_FILE = path.join(DATA_DIR, 't10k-labels-idx1-ubyte');
